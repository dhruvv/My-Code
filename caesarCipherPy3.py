# Caesar Cipher program for Python3 with tkinter GUI
...
heading = Label(window, text = 'Caesar Cipher', fg = "black", font = ("Courier", 36), bg = "gray")
heading.pack(side = TOP)

textlabel = Label(window, text = 'Text:     ', fg = "black", font = ("Courier", 14), bg = "gray")
textlabel.pack(side = LEFT)
textentry = Entry(window, bd = 4,bg = "green")
textentry.pack(side = LEFT)

shiftlabel = Label(window, text = '     Shift Number:     ', fg = "black", font = ("Courier", 14), bg = "gray")
